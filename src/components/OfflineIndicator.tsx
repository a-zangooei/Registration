...
export const OfflineIndicator: React.FC<{ onOpenManager: () => void }> = ({ onOpenManager }) => {
  ...
  return (
    <div className="fixed bottom-20 sm:bottom-6 left-4 right-4 sm:left-6 sm:right-auto z-40 max-w-sm bg-slate-900/95 text-white p-3 rounded-2xl shadow-xl border border-slate-700 backdrop-blur-md flex items-center justify-between gap-3 animate-fadeIn no-print">
